...
class ApiDocumentationSpec extends Specification implements FeaturesServiceIntegratorProvider {
    ...
    void "#_method #_endpoint has api documentation"() {
        ...
        where:
            ...
            'POST'   | '/groups/{feature_group_key}/activations'                                        | FEATURE_GROUP_TAG
            'GET'    | '/groups/{feature_group_key}/activations'                                        | FEATURE_GROUP_TAG
            'GET'    | '/groups/{feature_group_key}/activations/{activation_id}'                        | FEATURE_GROUP_TAG
            ...
            'POST'   | '/groups/{feature_group_key}/features/{feature_key}/activations'                 | FEATURE_TAG
            'GET'    | '/groups/{feature_group_key}/features/{feature_key}/activations'                 | FEATURE_TAG
            'GET'    | '/groups/{feature_group_key}/features/{feature_key}/activations/{activation_id}' | FEATURE_TAG
    }
